...
public class FOWSystem : MonoBehaviour
{
	...
	public class Revealer
	{
		...
		public LOSChecks mLos = LOSChecks.None;
		public Vector3 mPos = Vector3.zero;
		public float mInner = 0f;
		public float mOuter = 0f;
		public bool[] mCachedBuffer;
		public int mCachedSize;
		public int mCachedX;
		public int mCachedY;
	}
	...
	private static FOWSystem mInstance;
	...
	void RevealUsingRadius (Revealer r, float worldToTex)
	{
		...
		int radius = Mathf.RoundToInt(r.mOuter * r.mOuter * worldToTex * worldToTex);
	...
	{
		if (r.mCachedBuffer == null) RevealIntoCache(r, worldToTex);
	...
	void RevealIntoCache (Revealer r, float worldToTex)
	{
		...
		for (int i = 0, imax = size * size; i < imax; ++i) r.mCachedBuffer[i] = false;
